 ...
 *    Source:  https://github.com/terasolunaorg/terasoluna-gfw/blob/5.4.1.RELEASE/terasoluna-gfw-common-libraries/terasoluna-gfw-web/src/main/java/org/terasoluna/gfw/web/token/transaction/TransactionTokenContextImpl.java
 *
 * Modified by TIS Inc.
 */
/*
...
public class TransactionTokenContextImpl implements TransactionTokenContext {
     ...
     * @see TransactionTokenContext#createToken()
     ...
     * {@link TransactionTokenContextImpl.ReserveCommand#REMOVE_TOKEN}
     * @see TransactionTokenContext#removeToken()
     * @deprecated not work properly
     */
    @Deprecated
    @Override
